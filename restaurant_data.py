...
def favorite_restaurant():
    ...
    address1 = input('What is the addresss?: ')
    favorite_dish1 = input('What is your favorite dish?: ')
    
    favorite_restaurant  = {
           "name": name1,
           "address" : address1,
           "favorite_dish" : favorite_dish1
       }
...
def clean_print():
    ...
    #       url: https://www.yelp.com/biz/four-barrel-coffee-san-francisco`
    # etc etc
    for item in restaurant_1:
        print('{}: {}'.format(item,restaurant_1[item]))
